                ...
                <div class="page_content">
                    ...
                    <form method="POST" action="{!! action('AdminProfileController@changepass',['id' => $admin->id]) !!}" class="form-horizontal">
                                        ...
                                        <label for="input0" class="col-sm-2 control-label bring_right left_text">  كلمه المرور الحاليه*</label>
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control" name="cpass" id="admin_current_password" placeholder="ادخل كلمه المرور القديمه" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <label for="input0" class="col-sm-2 control-label bring_right left_text">  كلمه المرور الجديده*</label>
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control" name="newpass" id="admin_new_password" placeholder="ادخل كلمه المرور الجديده" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <label for="input0" class="col-sm-2 control-label bring_right left_text">  تأكيد كلمه المرور الجديده*</label>
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control" name="renewpass" id="admin_retype_password" placeholder="اعد كتابه كلمه المرور اجديده " required>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="add-product-footer">
                                            <button name="addProduct_btn" type="submit" class="btn btn-success add-product_btn">تحديث</button>
                                        </div>
                                    </form>
                    </div>
                </div>
