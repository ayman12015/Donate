                                ...
                                <div class="add-product-box">
                                    ...
                                    <form  method="POST" action="{!! action('SliderController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="slider_image">ارفاق صوره جديده*</label>
                                            <div class="col-sm-8">
                                                <input type="file" name="image" id="slider_image" accept="image/*" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="slider_title">عنوان السلايد* <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="title" id="slider_title" placeholder="e.g sports">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="slider_text">وصف السلايد* <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="text" id="slider_text" placeholder="e.g sports">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="slider_text _position">موضع السلايد*</label>
                                            <div class="col-sm-8">
                                                <select id="slider_text _position" name="text_position" class="form-control" required>
                                                    <option value="slide_style_left">شمال</option>
                                                    <option value="slide_style_center" selected>وسط</option>
                                                    <option value="slide_style_right">يمين</option>
                                                </select>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="add-product-footer">
                                            <button name="addProduct_btn" type="submit" class="btn btn-success add-product_btn">حفظ</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
