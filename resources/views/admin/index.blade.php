    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="login-form" dir="rtl">
                    ...
                    <div class="login-title">سجل الدخول</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" class="btn login-btn" name="button">دخول</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                COPYRIGHT 2020<a href="{{url('/')}}" target="_blank"> SADAKAT </a>
                </div>
            </div>
        </div>
    </div>
