...
@section('content')
     ...
     <div class="main_container col-lg-9 col-md-8 col-sm-9 col-xs- pull-left">
                <div class="row main_container_head">
                    <a href="{{url('user/campaign/create')}}" class="btn btn-default "style="border-radius: 19%;
                            ...
                            <table class="table">
                                ...
                                @foreach($campaigns as $campaign)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="campaign/{{$campaign->id}}" class="btn btn-success product-btn"><i class="fa fa-eye"></i> عرض </a>
                                                        <a href="campaign/{{$campaign->id}}/edit" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> تعديل </a>
                                                        @if($campaign->status != "closed")
                                                            <a href="campaign/{{$campaign->id}}/close" class="btn btn-warning product-btn"><i class="fa fa-toggle-on"></i> غلق </a>
                                                        @else
                                                            <a href="campaign/{{$campaign->id}}/open" class="btn btn-danger product-btn"><i class="fa fa-toggle-off"></i> فتح </a>
                                                        @endif
                                                        <a href="javascript:;" data-href="{{url('/')}}/user/campaign/{{$campaign->id}}/delete" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger product-btn"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
